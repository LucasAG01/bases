...
<!-- MOdiicacion del archivo, lmacena en una cookie el último instante en que el usuario visitó la página. Si es su primera visita,
  muestra un mensaje de bienvenida. En caso contrario, muestra la fecha y hora de su anterior visita. La cookie se guardará una semana.. -->
...
//COOKIE, Para poner el formato fecha en castellano y recuperar fecha y hora de acceso
...
// SI la cookie existe, recuperamos su valor
if(isset($_COOKIE['ultimaVisita'])){
    $ultimaVisita = $_COOKIE['ultimaVisita'];
    echo "<h3>Bienvenido de nuevo, su última visita fue el: $ultimaVisita</h3>";

}else{
    echo "<h3>Bienvenido a nuestra página web, es su primera visita</h3>";
}

// Guardamos la fecha de visita actual en una cookie que expira en una semana
setcookie('ultimaVisita', $fecha, time() + (7 * 24 * 60 * 60));
